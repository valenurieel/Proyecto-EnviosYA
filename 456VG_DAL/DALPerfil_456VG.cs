...
namespace _456VG_DAL
{
    public class DALPerfil_456VG
    {
        ...
        public Resultado_456VG<BEPerfil_456VG> aggPerfil456VG(BEPerfil_456VG perfil, int? parentId = null)
        {
            ...
            const string sql = @"
USE EnviosYA_456VG;
INSERT INTO PermisosComp_456VG (nombre_456VG,nombre_formulario_456VG,isPerfil_456VG,parent_id_456VG)
VALUES(@nombre,@formulario,@isPerfil,@parentId);";
            try
            {
                db.Conectar456VG();
                ...
                using (var cmd = new SqlCommand(sql, db.Connection, tx))
                {
                    ...
                    cmd.Parameters.AddWithValue("@formulario", perfil.permiso456VG ?? (object)DBNull.Value);
